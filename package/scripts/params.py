...
fair_scheduler_allocation_path= config['configurations']['impala-env']['fair_scheduler_allocation_path']
llama_site_path= config['configurations']['impala-env']['llama_site_path']
